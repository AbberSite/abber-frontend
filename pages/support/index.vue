  ...
  <main class="min-h-screen outline-none">
    ...
    <section
      ...
      <tempate v-if="tickets?.length == 0 && !loading">
        <div class="pt-4 text-sm text-gray-800 xs:text-base">لا توجد لديك بطاقات دعم</div>
      </tempate>
            ...
            <form class="w-full sm:max-w-sm" method="GET">
              <div class="w-full space-y-3">
                <div class="relative">
                  ...
                  <input v-model="filters.search" class="form-control h-[50px] px-12 " name="q" id="search"
                    placeholder="أبحث عن تذكرة معينة" required />
                  <button
            ...
            <div class="relative">
              ...
              <ClientOnly>
                <transition enter-active-class="transition-all" leave-active-class="transition-all"
                  ...
                  <FiltersDropdownTickets v-if="openFiltersDropdown"
