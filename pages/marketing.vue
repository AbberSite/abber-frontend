<template>
    ...
    <button class="rounded-full bg-gray-900 px-4 py-4 text-white hover:bg-gray-800 focus:outline-none" type="button"
      @click="open = !open" aria-label="مركز الخدمة">
      <!-- Heroicon name: outline/question-mark-circle -->
      <svg class="mx-auto" xmlns="http://www.w3.org/2000/svg" v-if="!open" width="24" height="24" fill="none"
            ...
            <div class="flex justify-center items-center space-x-6 pt-2 rtl:space-x-reverse md:pt-0">
                <a href="#" target="_blank" class="">
                    <img class="lazyload max-w-none"
                        ...
                        data-src="/images/payments/applepay.svg" height="21" width="36" alt="شعار وسيلة الدفع" />
                </a>
