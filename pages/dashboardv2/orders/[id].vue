<template>
  <div v-if="!loading" class="flex items-center justify-between">
    ...
    <div class="hidden items-center space-x-3 pb-12 rtl:space-x-reverse sm:flex">
      <button class="relative flex items-center justify-center space-x-1 rounded-md bg-gray-900 px-4 py-3 text-xs font-semibold text-white shadow-sm hover:bg-gray-800 rtl:space-x-reverse" type="button" @click="showChangeStatusWindow = true">
