<template>
      ...
      <div class="mx-auto max-w-prose lg:col-span-2 lg:max-w-full w-full">
        ...
        <div class="w-full" v-show="!loading">
          <div class="flex items-center justify-between text-gray-700">
            <a class="rounded-full bg-gray-900 px-4 pb-1 pt-2.5 text-[13px] font-semibold text-white hover:bg-gray-800" href="#">
          ...
          <div class="border-t border-gray-100 pt-8">
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-2 rtl:space-x-reverse">
                <a class="rounded-md border bg-white px-3 py-3 shadow-sm hover:bg-gray-50 hover:text-blue-500" :href="'https://www.facebook.com/sharer/sharer.php?href=' + currentUrl" target="_blank" title="مشاركة عبر الفيسبوك">
                ...
                <a class="rounded-md border bg-white px-3 py-3 shadow-sm hover:bg-gray-50 hover:text-sky-500" :href="`https://twitter.com/share?text=عبر%20-%20المدونة%20-%20${post?.title}&url=${currentUrl}&hashtags=hashtag1,hashtag2,hashtag3`" target="_blank" title="مشاركة عبر تويتر">
                ...
                <a class="rounded-md border bg-white px-3 py-3 shadow-sm hover:bg-gray-50" :href="`https://wa.me/?text=${currentUrl}`" target="_blank" title="مشاركة عبر الواتساب">
                  <svg class="fill-gray-900 hover:fill-[#40c351]" viewBox="0 0 24 24" height="20" width="20" xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <a class="rounded-md border bg-white px-3 py-3 shadow-sm hover:bg-gray-50 cursor-pointer" @click.prevent="copy()" title="نسخ رابط المقال">
              ...
              <div>
                <a class="block rounded-md border bg-white px-3 py-3 shadow-sm hover:bg-gray-50 cursor-pointer" @click.prevent="addToBookmarks" title="حفظ للقراءة لاحقا">
                  <Loading class="w-5 h-5" v-if="bookmarking" />
                  <svg v-else xmlns="http://www.w3.org/2000/svg" :class="[bookmarked ? 'fill-yellow-300' : 'fill-none']" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" height="20" width="20">
          ...
          <img class="mt-8 w-full rounded-xl bg-gray-50 lazyload" src="data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTk4IiBoZWlnaHQ9IjE5OCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIiB2ZXJzaW9uPSIxLjEiLz4=" :data-src="post?.image" height="216" width="384" alt="صورة المقالة" />
          <div class="js-toc-content prose prose-sm prose-gray pt-8 lg:prose-base lg:max-w-full" ref="contentEl" v-html="post?.content" />
  ...
  <Articles :similar-posts="similarPosts" :similar="true" :current-post-slug="post?.slug" title="مقالات" description="إقرأ المزيد من المقالات" />
</template>
