<template>
    ...
    <section
        ...
        <div class="grid w-full gap-x-8 lg:grid-cols-3">
            ...
            <div class="mx-auto max-w-prose lg:col-span-2 lg:max-w-full">
                ...
                <img
                    class="mt-8 w-full rounded-xl bg-gray-50"
                    :src="post?.image"
                    height="216"
                    width="384"
                    alt="صورة المقالة" />
                ...
                <div class="mt-8 border-t border-gray-100 pt-8">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-2 rtl:space-x-reverse">
                            <a
                                class="rounded-md border bg-white px-3 py-3 shadow-sm hover:bg-gray-50 hover:text-blue-500"
                            ...
                            <a
                                class="rounded-md border bg-white px-3 py-3 shadow-sm hover:bg-gray-50 hover:text-sky-500"
                            ...
                            <a
                                class="rounded-md border bg-white px-3 py-3 shadow-sm hover:bg-gray-50"
                                :href="`https://wa.me/?text=${currentUrl}`"
                                target="_blank"
                                title="مشاركة عبر الواتساب">
                                <svg
                                    class="fill-gray-900 hover:fill-[#40c351]"
                                    viewBox="0 0 24 24"
                                    height="20"
                                    width="20"
                                    xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a
                                class="rounded-md border bg-white px-3 py-3 shadow-sm hover:bg-gray-50 cursor-pointer"
                                @click.prevent="copy()"
                        ...
                        <div>
                            <a
                                class="block rounded-md border bg-white px-3 py-3 shadow-sm hover:bg-gray-50 cursor-pointer"
                                @click.prevent="addToBookmarks"
                                title="حفظ للقراءة لاحقا">
                                ...
                                <svg
                                    v-else
                                    xmlns="http://www.w3.org/2000/svg"
                                    :class="[bookmarked ? 'fill-yellow-300' : 'fill-none']"
                                    viewBox="0 0 24 24"
                                    stroke-width="2"
                                    stroke="currentColor"
                                    height="20"
