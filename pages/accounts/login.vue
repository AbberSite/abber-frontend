<template>
  <Head>
    ...
    <main class="min-h-screen outline-none">
        ...
        <!-- Login form section -->
        <section class="relative flex min-h-screen w-full flex-col items-center px-4 pb-36 pt-20 xs:px-6 md:pt-32" aria-labelledby="login-heading">
          ...
          <div class="mx-auto w-full max-w-sm pt-10">
            <form @submit.prevent="() => false">
              <fieldset class="space-y-7">
                <div class="w-full space-y-3">
                  ...
                  <input v-model="email" class="form-control h-[50px] appearance-none" type="email" name="email" id="email" placeholder="البريد الألكتروني" autocomplete="email" required />
                </div>
                <div class="w-full space-y-3">
                  <label class="text-sm font-semibold xs:text-base" for="password">كلمة المرور</label>
                  <div class="relative" x-data="{ show: false }">
                    <input v-model="password" class="form-control h-[50px] appearance-none"  :type="show ? 'text' : 'password'" name="password" id="password" placeholder="كلمة المرور" required />
                ...
                <div class="flex items-center justify-between text-sm xs:text-base">
                  <div class="flex items-center">
                    <input  class="h-6 w-6 flex-shrink-0 appearance-none rounded border" type="checkbox" name="remember" id="id_remember" />
                ...
                <div>
                  <button class="flex w-full h-[50px] items-center justify-center rounded-md border border-transparent bg-gray-900 px-8 py-3 text-sm font-semibold text-white hover:bg-gray-800 "> <span class="mt-1.5">تسجيل الدخول</span></button>
                </div>
              </fieldset>
            </form>
            <div class="pt-4">
              <RouterLink class="flex h-[50px] items-center justify-center rounded-md border bg-white px-8 py-3 text-sm font-semibold shadow-sm hover:bg-gray-50" to="#">
            ...
            <div class="space-x-1 pt-8 text-center text-sm rtl:space-x-reverse xs:text-base">
              ...
              <a class="font-medium text-blue-600" href="/accounts/register">سجل الان</a>
            </div>
          </div>
        </section>
      </main>
