<template>
    <main class="min-h-screen outline-none">
        ...
        <section class="relative flex min-h-screen w-full flex-col items-center justify-center px-4 pb-14 xs:px-6" aria-labelledby="forget-password-heading">
          ...
          <div class="mx-auto w-full max-w-sm pt-10">
            <form method="POST">
              <fieldset class="space-y-7">
                ...
                <div>
                  <a class="flex h-[50px] items-center justify-center rounded-md border border-transparent bg-gray-900 px-8 py-3 text-sm font-semibold text-white hover:bg-gray-800" href="/accounts/password/reset/done"> <span class="mt-1.5">إستعادة كلمة المرور</span></a>
                </div>
              </fieldset>
            </form>
            <div class="pt-8 text-center text-sm xs:text-base"><a class="font-medium text-blue-600" href="/accounts/login">العودة لتسجيل الدخول ←</a></div>
          </div>
        </section>
      </main>
</template>
