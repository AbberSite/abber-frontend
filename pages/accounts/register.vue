<template>
    ...
    <main class="min-h-screen outline-none">
        ...
        <!-- Login form section -->
        <section class="relative flex min-h-screen w-full flex-col items-center px-4 pb-36 pt-20 xs:px-6 md:pt-32"
                    ...
                    <fieldset class="space-y-7">
                        ...
                        <div class="w-full space-y-3">
                            ...
                            <div class="relative" x-data="{ show: false }">
                                <input class="form-control h-[50px] appearance-none" :type="show ? 'text' : 'password'"
                                ...
                                <button
                                    ...
                                    <svg class="hidden" :class="{ hidden: !show }" xmlns="http://www.w3.org/2000/svg"
                                        fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" height="20"
                                        width="20">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div>
                            <a class="flex h-[50px] items-center justify-center rounded-md border border-transparent bg-gray-900 px-8 py-3 text-sm font-semibold text-white hover:bg-gray-800"
                                href="/profile"> <span class="mt-1.5">التسجيل</span></a>
                        </div>
                    </fieldset>
                </form>
                <div class="pt-4">
                    <a class="flex h-[50px] items-center justify-center rounded-md border bg-white px-8 py-3 text-sm font-semibold shadow-sm hover:bg-gray-50"
                        href="#">
                        ...
                        <span class="ms-3 mt-1.5">إنشأ حسابك بواسطة جوجل</span>
                    </a>
                </div>
                <div class="pt-4">
                    <a class="flex h-[50px] items-center justify-center rounded-md border bg-white px-8 py-3 text-sm font-semibold shadow-sm hover:bg-gray-50"
                    ...
                    <span class="ms-3 mt-1.5">إنشأ حسابك بواسطة واتساب</span>
                </a>
            </div>
            <div class="pt-4">
                <a class="flex h-[50px] items-center justify-center rounded-md border bg-white px-8 py-3 text-sm font-semibold shadow-sm hover:bg-gray-50"
                    href="#">
                    <svg class="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="22" height="22"
                        viewBox="0 0 48 48">
                        <path
                    ...
                    <span class="ms-3 mt-1.5">إنشأ حسابك بواسطة ابل ايدي</span>
                </a>
            </div>
