        ...
        <div
          ...
          <nav class="pt-6">
            <button v-if="order?.add_review && isBuyer"
              ...
              <span class="ms-6 font-semibold">تقييم المعبر</span>
            </button>
            ...
            <button v-if="isBuyer && order?.status === 'awaiting_delivery' && !order?.content?.inquiry"
              ...
              <span class="ms-6 font-semibold">
                استفسار للمعبر
              </span>
            </button>

            <a v-if="false" :href="billUrl" target="_blank"
              class="group -mx-3 flex w-full items-center rounded-lg p-3 hover:bg-gray-50" type="button">
              <div class="flex h-11 w-11 items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                <!-- Heroicon name: outline/home -->
                <svg class="h-6 w-6 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
              ...
              <span class="ms-6 font-semibold">فاتورة الطلب</span>
            </a>
            ...
            <NuxtLink :to="{name: 'support'}" class="group -mx-3 flex w-full items-center rounded-lg p-3 hover:bg-gray-50" type="button">
              ...
              <span class="ms-6 font-semibold">الإبلاغ عن مشكلة</span>
            </NuxtLink>
            ...
            <button
              ...
              <span class="ms-6 font-semibold">إلغاء الطلب</span>
            </button>
          </nav>
        </div>
      </TransitionChild>
