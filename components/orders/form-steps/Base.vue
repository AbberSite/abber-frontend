    ...
    <section
        ...
        <div class="mx-auto w-full max-w-sm pt-10">
                <transition
                    ...
                    mode="out-in"
                >
                    <FormStepsContactType @next="next" v-if="activeStep == 0" />
                ...
                <ol class="flex items-center justify-center space-x-5 rtl:space-x-reverse" role="list">
                    ...
                    <li>
                        ...
                        <span class="relative flex items-center justify-center" aria-current="step">
                            <span class="absolute flex h-5 w-5 p-px" v-if="activeStep == 0" aria-hidden="true">
                                <span class="h-full w-full rounded-full bg-gray-200"></span>
                            </span>
                            <span class="relative block h-2.5 w-2.5 rounded-full "
                                :class="[(activeStep > 0) && 'bg-gray-200 hover:bg-gray-400',  (activeStep >= 0) && 'bg-gray-900']"
                            aria-hidden="true"></span>
                            <span class="sr-only">الخطوة الأولى</span>
                        </span>
                    </li>
                    ...
                    <li>
                        <!-- Current Step -->
                        <span class="relative flex items-center justify-center" aria-current="step">
                            <span class="absolute flex h-5 w-5 p-px" v-if="activeStep == 1" aria-hidden="true">
                                <span class="h-full w-full rounded-full bg-gray-200"></span>
                            </span>
                            <span class="relative block h-2.5 w-2.5 rounded-full "
                                :class="[(activeStep < 1) && 'bg-gray-200 hover:bg-gray-400',  (activeStep >= 1) && 'bg-gray-900']"
                            aria-hidden="true"></span>
                            <span class="sr-only">الخطوة الثانية</span>
                        </span>
                    </li>
                    ...
                    <li>
                        <!-- Current Step -->
                        <span class="relative flex items-center justify-center" aria-current="step">
                            <span class="absolute flex h-5 w-5 p-px" v-if="activeStep == 2" aria-hidden="true">
                                <span class="h-full w-full rounded-full bg-gray-200"></span>
                            </span>
                            <span class="relative block h-2.5 w-2.5 rounded-full "
                                :class="[(activeStep < 2) && 'bg-gray-200 hover:bg-gray-400',  (activeStep >= 2) && 'bg-gray-900']"
                            aria-hidden="true"></span>
                            <span class="sr-only">الخطوة الثالثة</span>
                        </span>
                    </li>
                    ...
                    <li>
                        <!-- Current Step -->
                        <span class="relative flex items-center justify-center" aria-current="step">
                            <span class="absolute flex h-5 w-5 p-px" v-if="activeStep == 3" aria-hidden="true">
                                <span class="h-full w-full rounded-full bg-gray-200"></span>
                            </span>
                            <span class="relative block h-2.5 w-2.5 rounded-full "
                                :class="[(activeStep < 3) && 'bg-gray-200 hover:bg-gray-400',  (activeStep >= 3) && 'bg-gray-900']"
                            aria-hidden="true"></span>
                            <span class="sr-only">الخطوة الرابعة</span>
                        </span>
                    </li>
