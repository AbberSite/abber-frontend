<template>
  ...
  <div class="pt-4" v-if="settings.api_settings?.active_login_methods?.website.includes('phone') && state.data?.authenticationMethod != 'login-sms'" >
    <button 
      class="flex w-full h-[50px] items-center justify-center rounded-md border bg-white px-8 py-3 text-sm font-semibold shadow-sm hover:bg-gray-50" 
      @click="() => (state.data as any).authenticationMethod = 'login-sms'">
  ...
  <div class="pt-4" v-if="state.data?.authenticationMethod != 'login'" >
    <button 
      class="flex w-full h-[50px] items-center justify-center rounded-md border bg-white px-8 py-3 text-sm font-semibold shadow-sm hover:bg-gray-50" 
      @click="() =>  (state.data as any).authenticationMethod = 'login'">
