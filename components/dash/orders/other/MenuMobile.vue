    ...
    <div class="fixed inset-0 sm:hidden z-50">
      ...
      <TransitionChild enter="transition ease-in-out duration-300 transform" enter-from="translate-y-full "
        ...
        <div
          ...
          <nav class="pt-6">
            <button class="group -mx-3 flex items-center rounded-lg p-3 hover:bg-gray-50"
              @click="emit('transferOrder'); emit('close')">
            ...
            <button class="group -mx-3 flex items-center rounded-lg p-3 hover:bg-gray-50" @click="emit('cancelOrder'); emit('close')">
              <div class="flex h-11 w-11 items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                <!-- Heroicon name: outline/home -->
                <svg class="h-6 w-6 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                  stroke-width="1.5" stroke="currentColor" aria-hidden="true">
            ...
            <button class="group -mx-3 flex items-center rounded-lg p-3 hover:bg-gray-50" @click="emit('sendMessage'); emit('close')">
              <div class="flex h-11 w-11 items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                <!-- Heroicon name: outline/home -->
                <svg class="h-6 w-6 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                  stroke-width="1.5" stroke="currentColor" aria-hidden="true">
            ...
            <button class="group -mx-3 flex items-center rounded-lg p-3 hover:bg-gray-50" @click="emit('sendAlert'); emit('close')">
              <div class="flex h-11 w-11 items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                <!-- Heroicon name: outline/home -->
                <svg class="h-6 w-6 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                  stroke-width="1.5" stroke="currentColor" aria-hidden="true">
...
const emit = defineEmits(['transferOrder', 'sendMessage', 'sendAlert', 'cancelOrder', 'close']);
