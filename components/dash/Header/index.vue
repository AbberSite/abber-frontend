    ...
    <header class="relative z-20 mx-auto max-w-7xl">
        ...
        <transition
            ...
            <div
                ...
                v-if="openDropdown">
                <DashHeaderMobileNavigation @close="openDropdown = false" @navigate="navigateAndClose" />
                <DashHeaderProfileCardMobile
                    v-if="status == 'authenticated'"
                    @logout="logout"
