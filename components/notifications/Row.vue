<template>
    <tr>
        <td class="whitespace-nowrap pb-4 pe-12 pt-6 font-medium">{{ notification?.message }}</td>
        <td class="whitespace-nowrap pb-4 pe-12 pt-6 font-medium" >{{ notification?.type ?? '--' }}</td>
