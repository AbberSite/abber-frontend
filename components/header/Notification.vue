<template>
  <li :class="[notification.read ? 'hover:bg-gray-50' : 'bg-gray-50']">
      ...
      <div class="flex items-start justify-between">
        <div class="flex items-center">
          <div class="flex-shrink-0">
            <NuxtImg loading="lazy" class="rounded-full bg-gray-100 md:h-10 md:w-10" sizes="44px md:40px" :src="notification.sender.image" height="44px" width="44px" alt="صورة المستخدم" />
          </div>
