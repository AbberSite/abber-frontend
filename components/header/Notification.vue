<template>
    ...
    <NuxtLink :to="notification.url.replace('orders/orders','orders').replace('orders/order','orders').replace('/wallets/withdrawal-requests/', '/wallet/withdrawal-requests/')" class="flex flex-col px-6 py-8 md:py-6">
