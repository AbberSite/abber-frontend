            ...
            <div
                ...
                <template v-for="(file, i) in modelValue">
                    <div class="relative">
                        ...
                        <NuxtImg class="lazyload w-20 h-20 rounded-md border " src="data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTk4IiBoZWlnaHQ9IjE5OCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIiB2ZXJzaW9uPSIxLjEiLz4=" :data-src="file.preview" alt="" />
                    </div>
                </template>
            </div>
        </div>
