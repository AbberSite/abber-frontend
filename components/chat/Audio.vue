<template>
    <div class="flex gap-4 items-center ">
        ...
        <div class="rounded-md bg-gray-900 flex items-center justify-center h-9 w-9 text-white cursor-pointer" @click="playPause" >
...
//         url: '/file/' + props.file.file.replace('https://d336rd5betdm19.cloudfront.net', ''),
//         height: 50,
//         width: 200,
//         barWidth: 5,
//         barRadius : 20, 
