<template>
    <div
        class="is-scroll flex w-full items-center space-x-6 overflow-x-auto border-b border-gray-100 pt-16 text-sm rtl:space-x-reverse xs:text-base lg:hidden"
        role="tablist"
        ...
        <button
            ...
            :class="{
                'border-gray-900': activeTab === 'details',
                'border-transparent text-gray-500 hover:text-gray-900': activeTab === 'chat'
            }">
            تفاصيل التذكرة
        </button>
    </div>
