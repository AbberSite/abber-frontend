        ...
        <form class="flex justify-center">
            <fieldset class="space-y-7 mt-3 max-w-sm">
                ...
                <div @click="submit('login')"
                    ...
                    <input class="h-5 w-5 flex-shrink-0 appearance-none rounded-full" id="login" type="radio"
                        name="type" v-model="authenticationMethod" value="login" />
                </div>
                <div @click="submit('register')"
                    class="flex cursor-pointer justify-between rounded-md border px-4 py-4 shadow-sm focus-within:border-gray-900 focus-within:ring-1 focus-within:ring-gray-900 focus:outline-none">
                    <div class="flex pt-1.5">
                        <div class="flex-shrink-0">
                            <!-- Heroicon name: outline/user-plus -->
                    ...
                    <input class="h-5 w-5 flex-shrink-0 appearance-none rounded-full" id="register" type="radio"
                        name="type" v-model="authenticationMethod" value="register" />
                </div>
            </fieldset>
        </form>
    </div>
