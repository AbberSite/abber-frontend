            ...
            <template v-else>
                <div class="px-6 pt-6">
                    ...
                    <div class="flex items-center justify-between py-4">
                        ...
                        <div class="font-medium">{{ order?.content?.platform }}</div>
                    </div>
                    <div class="flex items-center justify-between py-4">
                        <div class="font-medium text-gray-500">وسيلة الشراء</div>
                        <div class="font-medium">{{ order?.order_item_financial_data?.payment_method }}</div>
                    </div>
                    <div class="flex items-center justify-between py-4">
                    ...
                    <div class="flex">
                        ...
                        <div class="flex mr-2 items-center">
                            <NuxtLink class="font-medium text-sm hover:text-blue-600" :to="`/accounts/dashboard/user-update/${order?.buyer?.id}/#tab0`">{{ order.buyer?.first_name }}</NuxtLink>
                        </div>
                    </div>
                </div>
            </template>
            ...
            <template v-else>
                <div class="px-6 pt-6">
                    ...
                    <div class="flex items-center justify-between py-4">
                        ...
                        <div class="font-medium">{{0.00}} ر.س</div>
                    </div>
                    <div class="flex items-center justify-between py-4">
