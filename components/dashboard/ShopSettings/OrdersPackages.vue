<template>
    <DashboardTablesTable :head-items="{ package: 'الباقة', price:'السعر', expressors: 'المعبرون', users: 'المستخدمين' }" :body-items="data" :actions="{ remove: true, modify: true }" addButton />
