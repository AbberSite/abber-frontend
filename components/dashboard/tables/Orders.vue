      ...
      <table class="w-full table-auto">
        <thead>
          <tr class="bg-gray-2 text-right dark:bg-meta-4">
            ...
            <th class="min-w-[120px] py-4 px-4 font-medium text-black dark:text-white">حالة الطلب</th>
            <th class="min-w-[120px] py-4 px-4 font-medium text-black dark:text-white">نوع الطلب</th>
