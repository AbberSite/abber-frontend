    ...
    <div class="group relative flex">
      ...
      <div
        ...
        <div class="py-2">
          ...
          <NuxtLink class="flex items-center px-4 py-2 text-sm font-medium hover:bg-gray-50" href="/" role="menuitem"
            tabindex="-1">
            <!-- Heroicon name: outline/home -->
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
    ...
    <div class="group relative flex">
      ...
      <div
        ...
        <div class="py-2">
          ...
          <NuxtLink class="flex items-center px-4 py-2 text-sm font-medium hover:bg-gray-50" :to="{name: 'dashboardv2-help'}" role="menuitem"
            tabindex="-1">
            <!-- Heroicon name: outline/home -->
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
