<template>
  <div class="relative w-full" ref="dropdownRef">
    ...
    <div class="relative">
      <input
        type="text"
        class="form-input h-[50px] w-full pr-10 border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500"
      ...
      <div v-if="selectedItem" class="absolute inset-y-0 left-2 flex items-center">
