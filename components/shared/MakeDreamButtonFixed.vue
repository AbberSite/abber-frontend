<template>
    <div
        class="fixed bottom-0 z-20 flex w-full items-center space-x-3 border-t border-gray-100 bg-white px-4 py-6 rtl:space-x-reverse xs:px-6 sm:hidden" v-if="!['إدارة', 'معبر'].includes(data?.user_type)" >
