<template>
    <div class="w-full pt-8">
        <div class="flex items-center justify-between">
            <form class="w-full sm:max-w-sm" method="GET">
                <div class="w-full space-y-3">
                    <div class="relative">
                        ...
                        <input class="form-control h-[50px] px-12" type="search" name="q" v-model="filters.search"
                            id="search" placeholder="إبحث عن عملية مالية معينة" required />
            ...
            <div class="relative flex items-center gap-4">
                ...
                <button
                    ...
                    type="button" @click="filtersDropdown = true" aria-expanded="false" aria-haspopup="true">
                    <span class="flex items-center space-x-1 rtl:space-x-reverse">
                        ...
                        class="ms-1.5 rounded-full bg-gray-900 px-[6.5px] pt-1 text-white">{{ filtersCount }}</span>
                </button>
                ...
                <KeepAlive>
                    <transition enter-active-class="transition-all" leave-active-class="transition-all"
                        ...
                        <WalletTransactionsFiltersDropdown v-show="filtersDropdown"
        ...
        <div class="is-scroll w-full overflow-x-auto pt-6">
            <SkeletonsOrdersTable v-if="loading && transactions.length != 0" />
