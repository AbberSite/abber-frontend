...
<template>
  <div class="w-full pt-8">
    <div class="flex items-center justify-between">
      ...
      <div class="relative">
        <button class="hidden h-[50px] items-center justify-center rounded-md border bg-white px-4 py-3 text-xs font-medium shadow-sm hover:bg-gray-50 sm:flex" type="button" @click="pdfDropdown = true" aria-expanded="false" aria-haspopup="true">
