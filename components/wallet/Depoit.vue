            ...
            <TransitionChild
                ...
                <div class="fixed inset-0 z-40 bg-white sm:w-[340px]" v-cloak >
                    ...
                    <div class="flex items-center justify-between border-b border-gray-100 px-6 py-8">
                        <h2 class="text-lg font-semibold xs:text-xl">شحن الرصيد</h2>
                        <button
                        ...
                        <fieldset class="is-scroll space-y-7 overflow-y-auto px-6 py-8 pb-36">
                          <div class="w-full overflow-hidden rounded-lg bg-white p-4 shadow-sm ring-1 ring-black ring-opacity-5 transition-all duration-300 ease-in-out sm:max-w-sm" x-show="alert" role="alert">
                            <div class="mt-1.5 flex">
                              ...
                              <div class="w-0 flex-1 text-sm font-medium leading-loose">رسوم شحن الرصيد 200 ر.س. يمكنك الدفع من الرصيد المتبقي أو من المبلغ المراد شحنه</div>
                            </div>
                          </div>
                          <div class="w-full space-y-3" x-id="['input']">
                            <label class="block text-sm font-semibold xs:text-base" for="amount">المبلغ</label>
                            <input class="form-control h-[50px] appearance-none" type="text" name="text" id="amount" placeholder="إدخل المبلغ المراد شحنه" dir="rtl" value="" required />
                          </div>
                        </fieldset>
                      </div>
                      <div class="fixed bottom-0 w-full border-t border-gray-100 bg-white px-6 py-6 sm:w-[340px]">
                        <button class="flex h-[50px] w-full items-center justify-center rounded-md border border-transparent bg-gray-900 px-8 py-3 text-sm font-semibold text-white hover:bg-gray-800" type="submit"><span class="mt-1.5">متابعة</span></button>
                      </div>
                </div>
            </TransitionChild>
        </div>
