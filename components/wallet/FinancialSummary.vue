<template>
  <div class="grid w-full gap-x-8 gap-y-8 pt-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4" x-show="activeTab === 1" x-cloak>
    ...
    <button class="flex flex-col items-center justify-center space-y-6 rounded-md border-2 border-dashed bg-white px-4 py-8" type="button" @click="showDepoit = true">
