<template>
    ...
    <section class="relative flex min-h-screen w-full flex-col items-center justify-center px-4 pb-14 xs:px-6"
        v-if="isHome" aria-labelledby="forget-password-heading">
        ...
        <div class="rounded-md border border-gray-300 px-2 py-2 shadow-sm">
            <svg v-if="sender === 'whatsapp'" class="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
    ...
    <!-- Form steps OTP -->
    <form v-else method="POST" @submit.prevent="login" class="max-w-sm">
