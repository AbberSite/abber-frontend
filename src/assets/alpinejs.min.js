...
`
  ...
  function ut(e) {
    let t = [],
      r = (a) => t.push(a),
      [n, i] = zt(e);
    return t.push(i), [{ Alpine: F, effect: n, cleanup: r, evaluateLater: x.bind(x, e), evaluate: P.bind(P, e) }, () => t.forEach((a) => a())];
  }
  function En(e, t) {
    let r = () => {},
      n = mt[t.type] || r,
  ...
  function Nn(e, t, r) {
    ...
    i && ((e._x_transition.enter.during = { transformOrigin: m, transitionDelay: d, transitionProperty: v, transitionDuration: `${k}s`, transitionTimingFunction: f }), (e._x_transition.enter.start = { opacity: l, transform: `scale(${u})` }), (e._x_transition.enter.end = { opacity: 1, transform: 'scale(1)' })), o && ((e._x_transition.leave.during = { transformOrigin: m, transitionDelay: d, transitionProperty: v, transitionDuration: `${_e}s`, transitionTimingFunction: f }), (e._x_transition.leave.start = { opacity: 1, transform: 'scale(1)' }), (e._x_transition.leave.end = { opacity: l, transform: `scale(${u})` }));
  }
  function xr(e, t, r = {}) {
    e._x_transition ||
      (e._x_transition = {
  ...
  function Ne(e, t, { during: r, start: n, end: i } = {}, o = () => {}, s = () => {}) {
  ...
  function kn(e, t) {
    if (e.type === 'radio') e.attributes.value === void 0 && (e.value = t), window.fromModel && (e.checked = wr(e.value, t));
    else if (e.type === 'checkbox') Number.isInteger(t) ? (e.value = t) : !Number.isInteger(t) && !Array.isArray(t) && typeof t != 'boolean' && ![null, void 0].includes(t) ? (e.value = String(t)) : Array.isArray(t) ? (e.checked = t.some((r) => wr(r, e.value))) : (e.checked = !!t);
  ...
  var cs = { [1]: 'TEXT', [2]: 'CLASS', [4]: 'STYLE', [8]: 'PROPS', [16]: 'FULL_PROPS', [32]: 'HYDRATE_EVENTS', [64]: 'STABLE_FRAGMENT', [128]: 'KEYED_FRAGMENT', [256]: 'UNKEYED_FRAGMENT', [512]: 'NEED_PATCH', [1024]: 'DYNAMIC_SLOTS', [2048]: 'DEV_ROOT_FRAGMENT', [-1]: 'HOISTED', [-2]: 'BAIL' },
  ...
  p('model', (e, { modifiers: t, expression: r }, { effect: n, cleanup: i }) => {
    ...
    let c = () => {
      ...
      l = (m) => {
        let v;
        s((k) => (v = k)), fn(v) ? v.set(m) : a(() => {}, { scope: { __placeholder: m } });
      };
    typeof r == 'string' &&
      e.type === 'radio' &&
      h(() => {
